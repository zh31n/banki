    ...
    <div className={s.wrapper}>
      <div className={s.info}>
        ...
        <p>
          ...
          облигациям, валютам и сырью от ведущих брокерских компаний и банков, а
          также последние исследования и прогнозы от экспертов (НАЗВАНИЕ
          СЕРВИСА).
          <br />
          <br />
      ...
      <div className={s.items}>
        {markets.slice(0, 4).map((item) => (
          <LastRecommendItem key={item.id} item={item} />
        ))}
      </div>
    </div>
  )
