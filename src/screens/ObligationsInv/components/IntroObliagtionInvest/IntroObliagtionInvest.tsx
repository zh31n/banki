        ...
        <div className={s.intro}>
            <div className={s.info_cont}>
                ...
                <div className={s.sub}>
                    ...
                    <p>
                        Выбирайте облигации в рублях и в иностранной валюте (еврооблигации) для инвестиционного
                        портфеля, оценив срок вложений, степень риска, возможный доход. Здесь можно купить онлайн 430
                        ценных бумаг этого типа. Все данные актуальны на 04.09.2023.
                    </p>
                </div>
