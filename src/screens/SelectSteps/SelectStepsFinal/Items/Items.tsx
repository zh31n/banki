    ...
    return (
        <div className={styles.main_container}>
            ...
            <div className={styles.bank_container}>
                <p className={styles.text}>Промсвязьбанк</p>
                ...
                <div className={styles.info}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="19" viewBox="0 0 20 19" fill="none">
                        <g clip-path="url(#clip0_96_1055)">
                            <path d="M10 5.40039V10.0004" stroke="#4DA7FF" stroke-width="1.15" stroke-linecap="round"/>
                            <circle cx="10.0001" cy="12.2999" r="0.766667" fill="#4DA7FF"/>
                            <path d="M6.16634 2.59207C7.29401 1.93975 8.60324 1.56641 9.99967 1.56641C14.2339 1.56641 17.6663 4.99889 17.6663 9.23307C17.6663 13.4673 14.2339 16.8997 9.99967 16.8997C5.76549 16.8997 2.33301 13.4673 2.33301 9.23307C2.33301 7.83664 2.70635 6.5274 3.35867 5.39974" stroke="#4DA7FF" stroke-width="1.15" stroke-linecap="round"/>
                        </g>
                        <defs>
