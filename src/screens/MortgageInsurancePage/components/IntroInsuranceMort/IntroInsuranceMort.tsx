                    ...
                    <div className={s.l}>
                        <div className={s.cont_checks}>
                            <div className={s.check}>
                                <CustomCheckboxAround value={'Квартира'} current={current} setValue={setCurrent}
                                                      checked={true} type={'radio'}
                                />
                                Квартира
                            </div>
                            <div className={s.check}>
                                <CustomCheckboxAround value={'Жизнь'} current={current} setValue={setCurrent}
                                                      checked={false} type={'radio'}
                                />
                                Жизнь
                            </div>
                            <div className={s.check}>
                                <CustomCheckboxAround value={'Квартира + жизнь'} current={current} setValue={setCurrent}
                                                      checked={false} type={'radio'}
                                />
                                Квартира + жизнь
                            </div>
                            <div className={s.check}>
                                <CustomCheckboxAround value={'Квартира + жизнь1'} current={current} setValue={setCurrent}
                                                      checked={false} type={'radio'}
                                />
                                Квартира + жизнь
                            </div>
                        ...
                        <div className={s.inps_cont}>
                            <CustomWhiteSelectTitle width={385} title={'Банк, где у меня ипотека'}
                                                    options={['Сбербанк']}/>
