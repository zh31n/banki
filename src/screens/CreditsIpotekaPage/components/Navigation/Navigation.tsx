  ...
  return (
    <div className={styles.main_container}>
      ...
      <div className={styles.main_text_container}>
        ...
        <div className={styles.little_text}>На (НАЗВАНИЕ СЕРВИСА) можно с легкостью подобрать ипотечный кредит и
          оформить онлайн-заявку. Вы получите ипотеку на самых выгодных условиях*. У нас большая база ипотечных
          предложений от разных банков. Также на сайте вы найдете отзывы реальных клиентов и заключения экспертов
          (НАЗВАНИЕ СЕРВИСА) с описанием преимуществ и недостатков каждого предложения. Это позволит найти подходящий
          ипотечный кредит и быть уверенным в своем выборе!
        </div>
      </div>
      <Parametrs/>
          ...
          <div className={styles.item_cont}>
            <div className={styles.item_with_img}>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                <path d="M13.6322 6L8.96549 10L7.79883 9M4.29883 6L5.85438 7.33333" stroke="#212121" stroke-width="1.5"
