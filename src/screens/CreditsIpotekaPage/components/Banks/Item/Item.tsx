      ...
      <div className={styles.img_cont}>
        ...
        <div>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
            <path d="M19.5 9L12.5 15L10.75 13.5M5.5 9L7.83333 11" stroke="#4DA7FF" stroke-width="1.5"
          ...
          <div className={styles.cont}>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewBox="0 0 15 14" fill="none">
              <path
                ...
                stroke="#4DA7FF" stroke-linecap="round"/>
        ...
        <div className={styles.warning}>
          <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19" fill="none">
            <g clip-path="url(#clip0_261_12569)">
              <path d="M9.5 5.40039V10.0004" stroke="#4DA7FF" stroke-width="1.15" stroke-linecap="round"/>
              ...
              <path
                ...
                stroke="#4DA7FF" stroke-width="1.15" stroke-linecap="round"/>
            </g>
            <defs>
