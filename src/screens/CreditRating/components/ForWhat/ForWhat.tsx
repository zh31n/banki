        ...
        <div className={s.forWhat}>
            ...
            <div className={s.items_cont}>
                <div className={s.item}>
                    <Image src={for_what} style={{marginBottom: '10px', marginTop: '20px'}}/>
                ...
                <div className={s.item}>
                    <Image src={for_what_2}/>
                    <div className={s.title}>Экономьте время</div>
                    <p className={s.sub}>
                        После расчета кредитного рейтинга мы бесплатно подберем только те банки, которые готовы
                        выдать вам кредит.
                    </p>
                </div>
            </div>
