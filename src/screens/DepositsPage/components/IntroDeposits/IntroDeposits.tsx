    ...
    return (
        <div className={s.intro}>
            <div className={s.info}>
                <div className={s.breadCrumbs}>Главная / <mark>Вклады</mark></div>
                <div className={s.title}>Вклады <mark>в Москве</mark></div>
                <div className={s.sub}>
                    ...
                    актуальных предложений на
                    29.06.2023, а также регулярные акции с повышенной ставкой только для пользователей (НАЗВАНИЕ
                    СЕРВИСА).
                </div>
