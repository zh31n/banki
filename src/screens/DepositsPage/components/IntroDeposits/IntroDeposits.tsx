  ...
  return (
    <div className={s.intro}>
      <div className={s.info}>
        ...
        <div className={s.sub}>
          Сервис подбора вкладов и накопительных счетов позволяет быстро найти
          высокие процентные ставки,
          <mark>рассчитать доходность</mark> и <mark>открыть вклад онлайн</mark>
          . У нас самая полная база актуальных предложений на 29.06.2023, а
          также регулярные акции с повышенной ставкой только для пользователей
          (НАЗВАНИЕ СЕРВИСА).
        </div>
