    ...
    return (
        <div className={styles.main_container}>
            ...
            <div className={styles.text_container}>
                ...
                <p className={styles.text}>Как происходящее в мире влияет на ваши финансы. <br /> Советы экспертов, аналитика, инструкции, полезные подборки, <br /> личный опыт, лайфхаки.</p>
            </div>
