    ...
    return (
        <div className={styles.main_container}>
            <div className={styles.left_container}>
                ...
                <p className={styles.text}>Лучшие кредитные предложения для юридических лиц от крупнейших банков. Полное описание условий и экспертный анализ на (НАЗВАНИЕ СЕРВИСА)</p>
            </div>
