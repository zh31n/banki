...
const data = {
    ...
    CreditRating: {
        ...
        questData: [
            {title: 'Что означает кредитный рейтинг по шкале (НАЗВАНИЕ СЕРВИСА)?', text: ''},
            {title: 'Какие данные нужны, чтобы рассчитать мой кредитный рейтинг?', text: ''},
    ...
    SelectCardsPage: {
        questData: [
            ...
            {title: 'Безопасно ли оставлять данные на (НАЗВАНИЕ СЕРВИСА)?', text: ''},
            {title: 'Сколько времени займет заполнение заявки?', text: ''},
            {title: 'Какие данные понадобятся для подачи заявки на карту?', text: ''},
        ],
        ourData: [
            {
                img: w_1,
    ...
    DiscountIpotekaPage: {
        questData: [
            {title: 'Ипотека со скидкой от застройщиков, получить онлайн ипотеку со скидкой в 2023 году', text: ''},
            {title: 'Ипотечные кредиты в городах', text: ''},
            {title: 'Предложения в банках', text: ''},
            {title: 'Каталоги', text: ''},
    ...
    OSAGO: {
        ...
        favouritesQuestion: [
            ...
            {title: 'Чем отличается электронный полис е-ОСАГО от обычного бумажного полиса ОСАГО?', text: ''},
            ...
            {title: 'В каких регионах действителен полис страхования ОСАГО?', text: ''},
            {title: 'По какой причине удерживается РВД 23% при расторжении договора ОСАГО?', text: ''},
            {title: 'В какой срок необходимо застраховать купленный автомобиль?', text: ''},
            {title: 'Где посмотреть период использования полиса и срок страхования?', text: ''},
            ...
            {title: 'Порядок возмещения ОСАГО: куда обращаться за возмещением по ОСАГО?', text: ''},
            {title: 'Что относится к страховому случаю?', text: ''},
            {title: 'Сколько ущерба покрывает ОСАГО?', text: ''},
            {title: 'Как получить деньги по ОСАГО? В каких случаях выплачивают деньги?', text: ''},
            {title: 'Можно ли выбрать автосервис для ремонта машины самостоятельно?', text: ''},
            {title: 'Сгорает ли КБМ при перерыве в страховании?', text: ''},
            {title: 'Как застраховать автомобиль дешево?', text: ''},
            {title: 'Что делать, если нет положенной скидки за безопасное вождение? ', text: ''},
            ...
            {title: 'Можно ли вернуть стоимость полиса при продаже автомобиля?', text: ''},
        ],
        info: [
            {title: 'Виды ОСАГО', text: ''},
    ...
    TravelInsurance: {
        ...
        questData: [
            ...
            {title: 'Как рассчитывается или от чего зависит цена на страховку?', text: ''},
    ...
    HealthInsurance: {
        ...
        questData: [
            ...
            {title: 'В чем может быть польза страхования жизни и здоровья?', text: ''},
    ...
    ApplicationsProfile: {
        applicationItems: [
            {name: 'Полис ОСАГО', date: '21/07/2023', status: 1, contact: 'Маргарита Иванова'},
            {name: 'Полис ОСАГО', date: '21/07/2023', status: 2, contact: 'Маргарита Иванова'},
            {name: 'Полис ОСАГО', date: '21/07/2023', status: 0, contact: 'Маргарита Иванова'},
            {name: 'Полис ОСАГО', date: '21/07/2023', status: 0, contact: 'Маргарита Иванова'},
            {name: 'Полис ОСАГО', date: '21/07/2023', status: 0, contact: 'Маргарита Иванова'},
            {name: 'Полис ОСАГО', date: '21/07/2023', status: 0, contact: 'Маргарита Иванова'},
        ]
