...
const defaultState: StateInterface = {
    ...
    saveList: [
        {
            ...
            text: 'Вместе с ключевой ставкой растут и ставки по' +
    ...
    loansList: [
        {
            ...
            text: 'В мае—июне в России резко увеличилась доля микрозаймов, выплаты по которым просрочены.' +
    ...
    safeList: [
        {
            title: 'Пашинян назвал ошибкой зависимость от России в сфере безопасности',
            text: 'Ереван почти на 100% полагался на Москву, но сегодня «сама Россия' +
