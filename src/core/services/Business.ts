...
export const GET_BUSINESS_CARDS = (
  params: GetBusinessCardsParams = {},
): Promise<BusinessCardsResponseInterface> => {
...
export const GET_BUSINESS_CREDITS = (
  params: GetBusinessCreditsParams = {},
): Promise<BusinessCreditsResponseInterface> => {
...
export const GET_BUSINESS_CREDIT = (
  params: GetBusinessCreditParams,
): Promise<BusinessCreditResponseInterface> => {
