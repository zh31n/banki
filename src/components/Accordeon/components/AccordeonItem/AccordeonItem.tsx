    ...
    return (
        <div className={s.acc_item} onClick={handleActive} style={{maxHeight: active && '250px'}}>
            ...
            <div className={s.text}>
                ...
                Vestibulum pellentesque sagittis dolor in ornare. Morbi vitae metus tempor, maximus ante vel, suscipit
                libero. Vivamus sagittis nunc nec laoreet eleifend. P
            </div>
        </div>
    );
};
