...
const CalculateOSAGO = () => {
    return (
        <div className={styles.container}>
            <p className={styles.main_text}>Калькулятор <span>ОСАГО</span></p>
            ...
            <div className={styles.form_container}>
                ...
                <div className={styles.input_container}>
                    <button className={styles.button} disabled={true}>1 или более</button>
                    <button className={styles.button}>Неограниченно</button>
                </div>
                <div className={styles.input_container}>
                    <input className={styles.input} placeholder={'Минимальный возраст водителя'} style={{width: '327px', marginBottom:'0px'}} />
                    <input className={styles.input} placeholder={'Минимальный стаж вождения'} style={{width: '327px', marginBottom:'0px'}} />
                    <div className={styles.select}>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                            <path d="M12.6966 6.65039L8.02995 10.6504L6.86328 9.65039M3.36328 6.65039L4.91884 7.98372" stroke="#212121" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </div>
                </div>
                <p className={styles.text_little}>КБМ влияет на цену полиса и учитывает историю ДТП по собственной вине водителя</p>
            </div>
