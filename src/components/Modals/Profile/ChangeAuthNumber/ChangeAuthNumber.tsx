...
import s from './ChangeAuthNumber.module.scss';
...
const ChangeAuthNumber = () => {
    return (
        <div className={s.back}>
            <div className={s.modal}>
                <div className={s.modal_h}>
                    Изменения привязанного номера телефона
...
export default ChangeAuthNumber;